...
This repository contains a local-first pnpm workspace for an Ingeniería de Software I presentation. An academic portal presents three product proposals, and each proposal has an independently runnable Spanish-language Vite application with deterministic local fixtures and mock service states.
...
The **Portal de Propuestas** is the presentation surface for these three products. It provides proposal details, temporary comparison, and links to each app entry point.
